...
class JobScraper:
    def __init__(self):
        ...
        self.linkedin_base_url = "https://www.linkedin.com/search/results/content/?datePosted=%22past-month%22&keywords={}&origin=GLOBAL_SEARCH_HEADER&sortBy=%22relevance%22"
        ...
        with SB(uc=True, headless=False, user_data_dir=self.chrome_data_dir) as sb:
            for job in new_jobs_to_scrape:
                ...
                try:
                    ...
                    if job_data:
                        self.save_linkedin_data(job_data, output_csv)
